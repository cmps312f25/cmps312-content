...
class FruitRepository {
  ...
  static List<Fruit> getFruits() => [
        ...
        Fruit(
          ...
          description:
              'Grapes are small, sweet fruits that come in various colors, including green, red, and purple. They contain antioxidants known as polyphenols. Grapes are beneficial for heart health, can improve blood sugar balance, and contribute to eye health.',
        ),
      ];
}
